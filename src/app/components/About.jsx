          ...
          <h2 className="text-2xl font-semibold text-black mb-4">Education</h2>
            <ol class="relative border-s border-gray-200 dark:border-gray-700">
                ...
                <li key={index} class="mb-10 ms-6">
                    <span class="absolute flex items-center justify-center w-6 h-6 rounded-full -start-3 ring-8 dark:ring-gray-900">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6  text-blue-500  dark:text-blue-300">
            ...
            <ol class="relative border-s border-gray-200 dark:border-gray-700">
                ...
                <li key={index} class="mb-10 ms-6">
                    <span class="absolute flex items-center justify-center w-6 h-6  rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 ">
                      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 text-blue-800 dark:text-blue-300">
